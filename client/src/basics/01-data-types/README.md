...
This lesson covers the basics of JavaScript, the language that provides interactivity on the web. Let's start with variables and the data types that populate them!
...
3. **Change the variable value**. Change the variable value in the following way:
